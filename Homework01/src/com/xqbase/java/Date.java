...
class Date {
    ...
    public static boolean isValidDate(int month, int day, int year) {
        return year >=1 && (month >= 1 && month <= 12) && (day >= 0 && day <= daysInMonth(month, year));
    }
    ...
    public int difference(Date d) {
        ...
        difference = difference + after.dayInYear() + daysInYear(before.year) - before.dayInYear();

        return negative ? 0 - difference : difference;
    }

    /**
     * Return the total number of days of this year
